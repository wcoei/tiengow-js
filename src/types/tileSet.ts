...
const tileSet: Tiles[] = [
  ...
  { id: 8, code: "PLUM1", suit: Suits.Civil, rank: Civils.Plum },
  { id: 9, code: "PLUM2", suit: Suits.Civil, rank: Civils.Plum },
  ...
  { id: 14, code: "AXE1", suit: Suits.Civil, rank: Civils.Axe },
  { id: 15, code: "AXE2", suit: Suits.Civil, rank: Civils.Axe },
  ...
  { id: 20, code: "MALLET1", suit: Suits.Civil, rank: Civils.MalletSix },
  { id: 21, code: "MALLET2", suit: Suits.Civil, rank: Civils.MalletSix },
  ...
  { id: 27, code: "SEVEN2", suit: Suits.Military, rank: Militaries.Seven },
